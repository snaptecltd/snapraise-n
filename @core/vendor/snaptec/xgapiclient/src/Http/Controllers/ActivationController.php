...
namespace Snaptec\XgApiClient\Http\Controllers;
...
class ActivationController extends Controller
{
    ...
    public function licenseActivationUpdate(Request $request)
    {
        ...
        $has = hash_hmac('sha224',$data['product_activation_key'].$data['client'].$siteUrl,'snaptec');
        ...
        $msg = __('your server could not able to connect with snaptec license server, please contact support');
