...
class XgApiClient
{
    ...
    public function downloadAndRunUpdateProcess($productUid, $isTenant,$getItemLicenseKey,$version){
        ...
        $siteUrl = url('/');
        $has = hash_hmac('sha224',$getItemLicenseKey.$siteUrl,'snaptec');
    ...
    public function checkForUpdate($licenseKey,$getItemVersion){
        ...
        $has = hash_hmac('sha224',$licenseKey.$getItemVersion,'snaptec');
    ...
    {
        return "https://license.snaptec.com/api/";
    }
