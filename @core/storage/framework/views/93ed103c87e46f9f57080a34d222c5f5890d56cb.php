...
<?php if(preg_match('/(snaptec)/',url('/'))): ?>
    <div class="buy-now-wrap">
        <ul class="buy-list">
            <li><a target="_blank" href="https://docs.snaptec.ltd/docs/snaptec/" data-container="body" data-toggle="popover" data-placement="left" data-content="<?php echo e(__('Documentation')); ?>"><i class="far fa-file-alt"></i></a></li>
...
<script type="text/javascript">
    var Anaptec_API = Anaptec_API || {}, Anaptec_LoadStart = new Date();
    (function () {
        var s2 = document.createElement("script"), fs = document.getElementsByTagName("script")[0];
        s2.async = true;
        s2.src = "https://embed.snaptec.ltd/5e0b3e167e39ea1242a27b69.js";
        s2.charset = 'UTF-8';
...
<?php /**PATH C:\xampp\htdocs\snapraise\@core\resources\views/frontend/partials/footer.blade.php ENDPATH**/ ?>